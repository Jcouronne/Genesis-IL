...
class PickPlaceRandomBlockEnv:
    ...
    def step(self, RL_actions):
        ...
        action_mask_0 = RL_actions == 0  # Move above cube
        action_mask_1 = RL_actions == 1  # Move to cube
        action_mask_2 = RL_actions == 2  # Lift cube
        action_mask_3 = RL_actions == 3  # Move above target
        action_mask_4 = RL_actions == 4  # Place cube
        action_mask_5 = RL_actions == 5  # End position
        ...
        RL_states = torch.concat([block_position, target_position, gripper_position], dim=1)    
...
if __name__ == "__main__":
    gs.init(backend=gs.gpu, precision="64")
    RL_env = PickPlaceRandomBlockEnv(vis=True, device="cuda")
